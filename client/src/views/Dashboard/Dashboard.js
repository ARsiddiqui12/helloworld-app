...
class Dashboard extends Component {
  ...
  loopER()
  {
    ...
    let arr = Mainmenu.items;

var pi = '';
      arr.map(function(arr, i){
       pi += <li key={i}>{arr.name}</li>
     })
     return pi;
  ...
  {id: 'four', name: 'jane'},
    ...
    return (
      ...
      <Row>
        ...
        <div className="card-header" onClick={this.onShownHide.bind(this)}>

        <i className="fa fa-bars"></i> Main Menu

        </div>

        <div style={ shown } className="card-body">
